...
[![x-cmd/install — ainovel-cli Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/ainovel-cli.svg?lang=zh)](https://x-cmd.com/install/ainovel-cli)
...
合计: **62,564** 行代码（覆盖前 5 种语言、共 **330** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 62,255 | 4,617 | 5,822 | 324 |
| Python | 128 | 3 | 31 | 1 |
| Sh | 98 | 8 | 18 | 1 |
| Json | 54 | 0 | 0 | 3 |
...
- **Star**: 2,047 · **Fork**: 418 · **开放 issue**: 99 · **贡献者**: 7

## 累计统计

- **发布数**: 33 · **已合并 PR**: 12 · **开放 PR**: 4 · **已关闭 issue**: 83 · **开放 issue**: 16 · **提交数**: 300

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 3 | 1 | 2 | 6 | 4 | 13 |
| last60d | 2026-07-25 | 6 | 1 | 2 | 17 | 7 | 34 |
| 90d | 2026-06-25 | 17 | 8 | 3 | 44 | 13 | 82 |
| last180d | 2026-03-27 | 31 | 12 | 4 | 82 | 16 | 250 |
| 360d | 2025-09-28 | 33 | 12 | 4 | 83 | 16 | 284 |
| last720d | 2024-10-03 | 33 | 12 | 4 | 83 | 16 | 300 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/ainovel-cli.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T06:33:09Z._
